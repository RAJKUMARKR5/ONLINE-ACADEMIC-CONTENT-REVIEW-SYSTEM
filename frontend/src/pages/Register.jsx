            ...
            <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
                <div className="sm:mx-auto sm:w-full sm:max-w-md text-center animate-slide-up">
                    <div className="bg-white py-12 px-4 shadow-xl shadow-green-900/5 sm:rounded-2xl sm:px-10 border border-gray-100">
                        <CheckCircle size={56} className="text-[#10B981] mx-auto mb-6 animate-pulse-glow" />
                        ...
                        <Link 
                            ...
                            className="w-full flex justify-center py-3 px-4 rounded-xl shadow-md text-sm font-bold text-white transition-all transform hover:scale-[1.02] active:scale-[0.98]"
